...
import * as S from "./LeaveRequest.style";
import {
    userData,
    studentData,
    facultyData,
        ...
        <S.Container>
            ...
            {userType === "student" ? (
                <>
                    ...
                    <S.ButtonWrapper>
                        <S.LeaveButton disabled={userInfo.enrollment_status !== "enrolled"}
                            onClick={() => {
                        ...
                        <S.ReturnButton disabled={userInfo.enrollment_status !== "on_leave"}
                            onClick={() => {
